...
@MappedSuperclass
@EntityListeners(AuditingEntityListener.class) /// --> tells this class to listen to the AuditingEntityListener class, which is native to the Spring data framework
@Getter
@Setter
@ToString
